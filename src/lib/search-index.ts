...
const BASE_SEARCH_INDEX: SearchEntry[] = [
  ...
  // Use Cases
  { href: '/use-cases', title: 'Use Cases', description: 'Task-first guides for local AI agent security across OpenClaw, Claude Code, Codex CLI, MCP, and CI.', section: 'Use Cases', keywords: ['use cases', 'workflow', 'task first', 'local ai security', 'agent security', 'command order', 'scenario'] },
  { href: '/use-cases/openclaw-gateway', title: 'Protect OpenClaw Gateway', description: 'Secure OpenClaw gateway execution paths with runtime policy checks and signed evidence.', section: 'Use Cases', keywords: ['openclaw gateway security', 'openclaw runtime protection', 'tool execution policy', 'openclaw command order', 'run sequence'] },
  { href: '/use-cases/claude-code', title: 'Protect Claude Code', description: 'Protect Claude Code hooks, settings, plugins, and instruction files with policy enforcement.', section: 'Use Cases', keywords: ['claude code security', 'claude hooks protection', 'agents.md security', 'claude.md security', 'claude workflow', 'command sequence'] },
  { href: '/use-cases/codex-cli', title: 'Protect Codex CLI', description: 'Protect Codex CLI sessions with CI guard mode, trusted providers, and instruction safety checks.', section: 'Use Cases', keywords: ['codex cli security', 'openai codex security', 'trusted providers', 'ci guard mode', 'codex workflow', 'command sequence'] },
  { href: '/use-cases/mcp-gateway', title: 'Protect MCP Gateway', description: 'Protect MCP gateway provider trust and block unsafe metadata expansion.', section: 'Use Cases', keywords: ['mcp security', 'mcp gateway security', 'tool description poisoning', 'provider allowlist', 'mcp workflow', 'command order'] },
  { href: '/use-cases/ci-gating', title: 'Secure CI Gating', description: 'Secure pull requests and release pipelines with deterministic SkillGate policy enforcement.', section: 'Use Cases', keywords: ['ci security gate', 'github actions security gate', 'gitlab ci security gate', 'signed evidence', 'pipeline command order', 'ci workflow'] },
  ...
  { href: '/cli/reputation', title: 'reputation', description: 'Signed reputation graph: initialize baseline store, verify integrity, check bundle hashes, and submit verdicts.', section: 'CLI Reference', keywords: ['reputation', 'init', 'reputation init', 'verify', 'check', 'submit', 'verdict', 'bundle hash', 'graph', 'sg-rep-miss', 'reputation store', 'reputation.json', '--reputation-store', '--store'] },
